...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="about-image-band"><Image src="/media/worship-crowd.webp" alt="People gathered for a Christian worship service" fill sizes="100vw" /><p>Based in Nigeria.<br />Building for Christian audiences everywhere.</p></section>
