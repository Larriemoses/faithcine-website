...
export default function StoriesPage() {
  return <>
    ...
    <section className="product-page-visual section-shell"><Image src="/media/camera-production.jpg" alt="A filmmaker working with a cinema camera" fill sizes="100vw" unoptimized /><div><p>Christian stories rooted in faith and African life.</p></div></section>
