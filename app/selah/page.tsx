...
export default function SelahPage() {
  return <>
    ...
    <section className="section-shell editorial-split"><div><p className="section-number">Access and language</p><h2>Designed for the devices and networks people use.</h2></div><p className="large-copy">Research begins in Nigeria and considers mobile use, unstable connections, data cost, lower cost Android devices, and the care required for language support. English will come first. Other languages will be added only when translation rights, pronunciation, native review, and theological review are ready.</p></section>
